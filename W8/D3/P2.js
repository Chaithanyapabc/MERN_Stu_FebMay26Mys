...
async function runSaveHookDemo(){
    try{
        ...
        articleSchema.pre("save",function(){
            //before save the data executes middleware
            this.title = this.title.trim();
            console.log("pre-save hook: titel normalized before save");
        });
        articleSchema.post("save",function(doc){
            console.log("post-save hook: document save with titel",doc.title);
        });
